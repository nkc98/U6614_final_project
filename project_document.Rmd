...
To control for time-variant, county-variant factors, we pull demographic data from the US Census Bureau's American Community Survey (ACS), for years 2011-2018. Data is downloaded from the US Census Bureau API using the package tidycensus.
