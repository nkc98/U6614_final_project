...
We test both a difference-in-difference model and an event study model.

## Difference-in-Difference Results

We estimate difference-in-difference effects for all counties, "high risk," and "low risk" counties. 
