...
We add a dummy variable into our data to reflect this policy difference.
...
# We only keep columns for FIPS codes (merging purposes) and modeled overdose deaths

overdose_data <- overdose_data %>% 
  select(FIPS, `Model-based Death Rate`) %>%
